...
let marvl_heros=["ironman","spiderman","antman","Thor","caption America"];
...
let marvel_heros = ["ironman", "spiderman", "antman", "Thor", "captain America"];
console.log(marvel_heros.splice(1, 2, "captain marvel"));
console.log(marvel_heros); // This will show the updated array