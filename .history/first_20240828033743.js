...
//adding in splice
// let marvel_heros=["ironman","spiderman","antman","Thor","caption America"];
// console.log(marvel_heros.splice(2,0,"loky"));   //2 index per 0 delete kerna or 2 index kay bad loky add kerna
// console.log(marvel_heros);

// //deleting element
// let marvel_heros=["ironman","spiderman","antman","Thor","caption America"];
// console.log(marvel_heros.splice(4,1));   //4th index per aik value del ker do caption america del ho jahay ga
// console.log(marvel_heros);

// //replacing value

// let marvel_heros=["ironman","spiderman","antman","Thor","caption America"];
// marvel_heros.splice(2, 1, "caption marvel");
// console.log(marvel_heros);

//  let companies=["blooberg","Microsoft","Uber","google","IBM","Netflix"];
// //remove first company from the array
//  companies.shift();   //1 index wali value del ker do

// //remove uber and add ola in its place
//  companies.splice(2,1,"Ola");   // 2 index per 1 del and ola add
...
// //function
// //aik bar bana lay tho kabi be call ker saqtay jasay cook ho gaya jasay personal sectory ho gaya

// //defining function
// function myfunction(){
//   console.log("Hello Fizza");
//   console.log("Enjoying JS!");
// }

// //function call
// myfunction();       //function kay ander likhi chizay screen per ahh jahay ge



// //defining function may jo msg hota ossay parameter khatay ha
// function myfunction(msg){
//   console.log(msg);                //parameter
// }

// console.log("enjoying js");     //defining function may msg jo ha wo argument ho ga
...
//function
//global variable     koi be function a ko access ker saqta
a=12;
function myfunction(){
 console.log(a);
}
