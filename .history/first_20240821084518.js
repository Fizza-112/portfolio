...
for(let i=1; i<=5; i++){       //  i=1 is the starting value of loop , i<=5  mean jub tak 5 ya 5 say chotta loop chalaho
                          // i++ mean update krtay jaho chalatay jaho jub tak i<=5 rahta
