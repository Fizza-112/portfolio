...
let marvel_heros=["ironman","spiderman","antman","Thor","caption America"];
console.log(marvel_heros.splice(1,2,0));      //starting index,phr delete kitnay elements kernay ,new elemment add
//1 index kay bad 2 element delete ker do or 0 add kero yani add kuch be na kero
