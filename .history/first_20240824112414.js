...
//slice method   starting and ending index bata daitay ha or oiss may say aik tokera nikal laitay ha 
//ending index kabi show nahi hota oiss say pahlay waliyo tak tokera milta
let marvel_heros=["ironman","spiderman","antman","Thor","caption America"];
console.log(marvel_heros.slice(1,4));
