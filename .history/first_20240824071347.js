...
let arr=[23,22,21,20,19,10];

console.log(arr.push(12));  //12 array may add ho jahay ga
console.log(arr.push(13,14,15));  //multiple chizo ko add kerna output may total length show ho ge
console.log(arr);
